...
def converse(query):
    ...
    url = "https://discoveryengine.googleapis.com/v1alpha/projects/413847466250/locations/global/collections/default_collection/dataStores/kms-agent-datastore/servingConfigs/default_search:search"
